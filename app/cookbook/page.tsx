...
const RecipeCard: React.FC<{ recipe: Recipe; onDelete: (recipeId: number) => void }> = ({ recipe, onDelete }) => {
            ...
            {ALL_LABELS.map((label) => (
              <Tag
                ...
                style={{
                  ...
                  padding: "2px 12px",
                  fontSize: 13,
                  background: activeLabels.includes(label) ? "#4a6741" : "#e4e1e1",
                  color: activeLabels.includes(label) ? "#1a1a1a" : "#555",
                  border: "none"
                }}
              >
                {label}
